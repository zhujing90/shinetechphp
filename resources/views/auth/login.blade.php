    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        ...
        <form class="m-t" role="form" method="POST" action="{{ route('auth.login') }}">
            ...
            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                <input type="email" name="email" class="form-control" placeholder="@lang('auth.login.form.email')"
            ...
            <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                <input type="password" name="password" class="form-control" placeholder="@lang('auth.login.form.senha')"
                       required="">
            ...
            <a href="{{ route('auth.password.forgot') }}">
                <small>@lang('auth.login.forgot')</small>
            </a>
        </form>
